...
CREATE TABLE [dbo].[U_TBLINVHEADER_RECLASSIFIED_LOG](
	...
	[INVHED_SETUPLOC] [varchar](3) NULL,
	[INVHED_LOCCODE] [varchar](3) NOT NULL,
	[INVHED_INVNO] [varchar](10) NOT NULL,
	...
	[INVHED_SHITNO] [numeric](18, 0) NULL,
	[INVHED_TEMCASHIER] [varchar](10) NULL,
	[INVHED_MEMBER] [varchar](8) NULL,
	[INVHED_PRICEMODE] [varchar](5) NULL,
	[INVHED_REFMODE] [varchar](3) NULL,
	[INVHED_REFNO] [varchar](10) NULL,
	[INVHED_GROAMT] [numeric](18, 2) NULL,
	[INVHED_DISPER] [numeric](18, 2) NULL,
	[INVHED_DISAMT] [numeric](18, 2) NULL,
	[INVHED_LINEDISCPERTOT] [numeric](18, 2) NULL,
	[INVHED_LINEDISAMTTOT] [numeric](18, 2) NULL,
	[INVHED_ADDAMT] [numeric](18, 2) NULL,
	[INVHED_NETAMT] [numeric](18, 2) NULL,
	[INVHED_PAYAMT] [numeric](18, 2) NULL,
	[INVHED_DUEAMT] [numeric](18, 2) NULL,
	[INVHED_CHANGE] [numeric](18, 2) NULL,
	[INVHED_POINTADDED] [numeric](18, 2) NULL,
	[INVHED_POINTDEDUCT] [numeric](18, 2) NULL,
	[INVHED_PRINTNO] [numeric](18, 0) NULL,
	...
	[INVHED_ORDNUMBER] [varchar](10) NULL,
...
CREATE TABLE [dbo].[U_TBLINVPAYMENTS_RECLASSIFIED_LOG](
	...
	[INVPAY_SETUPLOC] [varchar](3) NULL,
	[INVPAY_LOCCODE] [varchar](3) NULL,
	[INVPAY_INVNO] [varchar](10) NULL,
	...
	[INVPAY_SEQUENCE] [numeric](18, 0) NOT NULL,
...
BEGIN
	...
	INSERT INTO U_TBLINVHEADER_RECLASSIFIED_LOG select GETDATE(),* from T_TBLINVHEADER where INVHED_LOCCODE=@LOC_CODE and INVHED_INVNO=@INVOICE_NO and INVHED_MODE=@invMode
...
-- save inv header
	...
	INSERT into U_TBLINVPAYMENTS_RECLASSIFIED_LOG select GETDATE(),*  from T_TBLINVPAYMENTS where INVPAY_LOCCODE=@LOC_CODE and INVPAY_INVNO=@INVOICE_NO and INVPAY_MODE=@invMode
